...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      ...
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.AnonymousCheckIn__factory>;
    getContractFactory(
      name: "ZamaFheCheckIn",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.ZamaFheCheckIn__factory>;
    ...
    getContractAt(
      ...
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.AnonymousCheckIn>;
    getContractAt(
      name: "ZamaFheCheckIn",
      address: string | ethers.Addressable,
      signer?: ethers.Signer
    ): Promise<Contracts.ZamaFheCheckIn>;
